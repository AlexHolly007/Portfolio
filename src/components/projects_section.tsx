    ...
    return (
        ...
        <div className="scroll-proj-point1">
            ...
            <div className="container">
                <WebsiteProject text="Capstone Project - Full Stack, Data visualization, PostgreSQL, Alphafold" url="https://venome.cqls.oregonstate.edu/" thumbnailUrl={venome} gh_link="https://github.com/Venom-Biochem-Lab/venome"/>
                ...
                <WebsiteProject text="Student Canvas API - GCP, SQL DB, Flask, Postman" url="https://github.com/AlexHolly007/Student-Canvas-GCP" thumbnailUrl={canvas_ex} gh_link="https://github.com/AlexHolly007/Student-Canvas-GCP"/>
